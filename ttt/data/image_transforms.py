"""
Defines all transforms to be applied on an image
"""
...
from ttt.utils.typing import TransformDict
...
if __name__ == '__main__':
    ...
    image_transformer = ImageTransformer(transform_dict)
    _signal = image_transformer(signal)

    assert signal.shape == (32, 32, 3) and _signal.shape == (3, 224, 224)
